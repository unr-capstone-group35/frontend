<template>
  ...
  export default {
    ...
    data() {
      return {
        topics: [
          { id: 1, name: "Computer Science Basics", description: "Detailed roadmap for CS Basics..." },
          { id: 2, name: "Data Structures", description: "Detailed roadmap for Data Structures..." },
          { id: 3, name: "Algorithms", description: "Detailed roadmap for Algorithms..." },

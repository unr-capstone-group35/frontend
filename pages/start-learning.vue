  ...
  >
    <main class="mx-auto max-w-7xl p-4 py-12 sm:p-6 sm:py-16 lg:p-12 lg:py-24">
      ...
      <div v-if="loading" class="flex min-h-[50vh] items-center justify-center">
        <div
          class="h-12 w-12 animate-spin rounded-full border-b-2 border-emerald-500"
        ></div>
      </div>
      ...
      <div v-else class="space-y-24">
        ...
        <section
          class="flex flex-col gap-8 border-b border-gray-200 pb-12 dark:border-gray-700 lg:flex-row"
        >
          <div class="lg:w-2/5">
            ...
            <p
              class="mb-6 text-lg leading-relaxed text-gray-600 dark:text-gray-300"
            >
              Start your coding journey here. Learn variables, functions, loops,
              and essential programming concepts through interactive exercises
        ...
        >
          <div class="lg:w-2/5">
            ...
            <p
              class="mb-6 text-lg leading-relaxed text-gray-600 dark:text-gray-300"
            >
              Learn how to organize and store data efficiently. Master
              fundamental data structures used in modern software development.
            </p>
            <ul class="list-inside list-disc text-gray-600 dark:text-gray-300">
        ...
        <section class="flex flex-col gap-8 lg:flex-row">
          <div class="lg:w-2/5">
            ...
            <p
              class="mb-6 text-lg leading-relaxed text-gray-600 dark:text-gray-300"
            >
              Master essential algorithms and computational problem-solving.
              Learn to analyze and implement efficient solutions to complex
              problems.
            </p>
            <ul class="list-inside list-disc text-gray-600 dark:text-gray-300">

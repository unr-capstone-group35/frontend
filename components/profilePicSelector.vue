      ...
      try {
        ...
        if (error && error.message) {
          if (error.message.includes("inappropriate content")) {
            ...
            uploadError.value =
              "Unable to verify image content. The safe search service is currently unavailable. Please try again later or choose a different image.";
          } else if (error.message.includes("500")) {
            uploadError.value =
              "Server error. The profile picture service is currently experiencing issues. Please try again later.";
          } else {

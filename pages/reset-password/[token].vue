  ...
  <div class="page-container flex flex-col">
    <div class="flex w-full flex-1 items-center justify-center">
      <div class="card w-full max-w-md p-6">
        ...
        <div
          v-if="!tokenChecked"
          class="mb-4 rounded bg-gray-100 p-4 text-gray-700 dark:bg-gray-800 dark:text-gray-300"
        >
        ...
        <div
          ...
          class="mb-4 rounded bg-red-100 p-4 text-red-700 dark:bg-red-900/50 dark:text-red-200"
        >
          <p>{{ resetError }}</p>
          <p class="mt-4">
        ...
        <div
          ...
          class="mb-4 rounded bg-green-100 p-4 text-green-700 dark:bg-green-900/50 dark:text-green-200"
        >

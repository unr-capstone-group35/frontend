...
<template>
  <div class="flex min-h-screen flex-col">
    <div class="flex flex-1 bg-gray-100 dark:bg-gray-900">
      <!-- Sidebar for Topics -->
      <aside
        class="w-1/4 overflow-y-auto bg-white p-6 shadow-md dark:bg-gray-800"
      >
      ...
      <main class="flex-1 overflow-y-auto p-8">
        <div
          v-if="getMainContent()"
          class="rounded-lg bg-white p-10 shadow-md dark:bg-gray-800"
        >
          ...
          <div
            class="mb-4 border-b-2 border-gray-300 dark:border-gray-600"
          ></div>
        ...
        <div
          v-if="getEmptyState()"
          class="text-center text-xl text-gray-500 dark:text-gray-400"
        >
...
export default {
      ...
      topics: [
        {
          ...
          description:
            "Master the fundamental concepts of computer science and programming"
        },
        {
          id: "data-structures",
          name: "Data Structures",
          description:
            "Dive deep into essential data structures that power modern software"
        },
        {
          id: "algorithms",
          name: "Algorithms",
          description:
            "Master complex algorithms and optimization techniques used in modern software development"
        }
      ],
  ...
  methods: {
    getTopicClasses(topicId) {
      let baseClasses =
        "p-4 cursor-pointer hover:bg-emerald-100 dark:hover:bg-emerald-900/50 transition"
